...
months.forEach(element=>{
  numbers.push(localStorage.getItem(element));
  // console.log(element)
})
...
const doughnutChart = new Chart(document.getElementById('doughnutChart'), {
  ...
  data: {
    ...
    datasets: [
      {
        data: [localStorage.getItem('Oct'), localStorage.getItem('Nov'), localStorage.getItem('Dec')],
...
user_count.innerText = localStorage.getItem("Users")


const sales = document.getElementById('sales')
sales.innerText = "$" + localStorage.getItem("Value")

const churners = document.getElementById('churners')
churners.innerText = localStorage.getItem('Churners')