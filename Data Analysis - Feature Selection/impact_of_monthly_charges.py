...
monthly_charges = initial_dataset['MonthlyCharges']
monthly_charges_mean = monthly_charges.mean()

two_groups = monthly_charges.groupby(monthly_charges <= monthly_charges_mean)
...
monthly_charges_churn = initial_dataset[['MonthlyCharges', 'Churn']]
monthly_charges_churn_mean = monthly_charges.mean()

two_groups = monthly_charges_churn.groupby(monthly_charges <= monthly_charges_churn_mean)
less_than_mean = two_groups.get_group(1)
greater_than_mean = two_groups.get_group(0)
