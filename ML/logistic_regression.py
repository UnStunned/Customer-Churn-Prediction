...
if __name__ == '__main__':
    print(f'Accuracy of logistic regression on customer churn is {accuracy*100}')
    # print(f'Precision of logistic regression on customer churn is {precision}')
    # print(f'Recall of logistic regression on customer churn is {recall}')
    # print(f'F1 score of logistic regression on customer churn is {f1}')