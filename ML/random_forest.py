...
if __name__ == '__main__':
    print(f'Accuracy of random forest on customer churn is {accuracy*100}')
    # print(f'Precision of random forest on customer churn is {precision}')
    # print(f'Recall of random forest on customer churn is {recall}')
    # print(f'F1 score of random forest on customer churn is {f1}')