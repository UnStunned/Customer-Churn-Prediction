...
selected_dataset = initial_dataset.drop(columns=['customerID', 'gender', 'PhoneService', 'MultipleLines'])
...
intermediate_dataset_1 = intermediate_dataset_1.drop(
    columns=['InternetService_No', 'OnlineSecurity_No internet service',
...
support_vector_machine = SVC(C=15)
support_vector_machine.fit(X_train, y_train)
accuracy = support_vector_machine.score(X_test, y_test)
...
if __name__ == '__main__':
    print(f'Accuracy of support vector machine on customer churn is {accuracy*100}')
    # print(f'Precision of support vector machine on customer churn is {precision}')
    # print(f'Recall of support vector machine on customer churn is {recall}')
    # print(f'F1 score of support vector machine on customer churn is {f1}')